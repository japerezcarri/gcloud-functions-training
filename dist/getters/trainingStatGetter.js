 ...
 */
function trainingStatGetter(req, res, redisClient) {
    return __awaiter(this, void 0, void 0, function () {
        var redisGet, countSent, countReceived, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    redisGet = util_1.promisify(redisClient.get).bind(redisClient);
                    return [4 /*yield*/, redisGet("U_" + req.query.id + "_N_S")];
                case 1:
                    countSent = _a.sent();
                    return [4 /*yield*/, redisGet("U_" + req.query.id + "_N_R")];
                case 2:
                    countReceived = _a.sent();
                    if (countReceived !== null || countSent !== null) {
                        ...
                        return [2 /*return*/, res.status(404).send("User id not found")];
                    }
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
...
exports.default = trainingStatGetter;
