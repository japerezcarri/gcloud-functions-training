 ...
 */
function trainingSubAlert(body, context, cb, redisClient) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, util_1.promisify(redisClient.set).bind(redisClient)("M_" + message.messageId + "_A", body)];
                case 1:
                    _a.sent();
                    return [2 /*return*/, cb()];
                case 2:
...
exports.default = trainingSubAlert;
