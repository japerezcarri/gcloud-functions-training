...
var pubsub;
if (topic !== undefined) {
    pubsub = new pubsub_1.PubSub().topic(topic);
}
/**
 ...
 */
function trainingPub(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var message, pubsubResponse, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, pubsub.publish(Buffer.from(JSON.stringify(message), "utf-8"))];
                case 1:
                    pubsubResponse = _a.sent();
                    pubsubResponse = "Message published - " + pubsubResponse;
                    console.log(pubsubResponse);
                    return [2 /*return*/, res.status(200).send(pubsubResponse)];
                case 2:
                    error_1 = _a.sent();
                    console.log(error_1);
